...
import Logo from "../admin/layout/img/Logo + Hải âu.png";
  ...
  return (
    <div className={`${styles.login}`}>
      ...
      <div className={`${styles.formControl}`}>
        ...
        <p className={styles.user}>Đăng nhập vào hệ thống trang web của bạn</p>
        <form>
          ...
          <div className={`${styles.button}`}>
            <button className="btn btn-primary m-4">Đăng Nhập</button>
          </div>
        </form>
      </div>
    </div>
